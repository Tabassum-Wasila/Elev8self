=== WP Data Access ===
Contributors: peterschulznl, maxxschulz, kimmyx, aaronvincentlee, freemius
Tags: table builder, form builder, datatable, datatables, data table, data tables, table, tables, responsive tables, dynamic tables, sortable tables, csv, json, xml, remote database, remote databases, large tables, big tables, spreadsheet, google sheets, charts, data, database, business intelligence, data entry
...
The best WordPress table plugin with an intuitive table builder and a highly customizable form builder to support data entry
