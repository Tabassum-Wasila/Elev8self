        ...
        if ( null === $wpdadb ) {
            ...
            if ( is_array( $search ) && isset( $search['value'] ) ) {
                ...
                foreach ( $_POST['columns'] as $column ) {
                    if ( isset( $column['name'], $column['searchable'], $column['data_type'] ) && 'true' === $column['searchable'] ) {
                        $columns_searchable[] = array(
                            'column_name' => sanitize_text_field( wp_unslash( $column['name'] ) ),
                            'data_type'   => sanitize_text_field( wp_unslash( $column['data_type'] ) ),
                        );
                    }
                }
                // Add search filter.
