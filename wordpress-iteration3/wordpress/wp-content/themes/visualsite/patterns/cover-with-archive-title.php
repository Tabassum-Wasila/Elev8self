<?php
  ...
  * Slug: visualsite/cover-with-archive-title
...
<div class="wp-block-cover alignfull" style="min-height:300px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-55" alt="" src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/bg-cover-2.jpeg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"archive","textAlign":"center","textColor":"background"} /--></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->